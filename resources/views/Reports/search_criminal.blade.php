...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <h1 class="text-center">DESCARGAR REPORTES EN PDF</h1>
@stop
                ...
                <table class="table table-hover" id="criminales">
                    ...
                    <tbody>
                        @foreach ($crimi as $criminals)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex flex-column align-items-start">
                                        <a href="{{ route('document.generate.complete', $criminals->id) }}"
                                            class="btn btn-warning btn-sm w-100 mb-2">Descargar 1</a>
                                        <a href="{{ route('document.generate.fast', $criminals->id) }}"
                            ...
                            <!-- Modal para la fotografía (colocar fuera de la tabla, preferiblemente al final de la vista) -->
                            @if ($ultimaFoto)
        ...
        $(document).ready(function() {
            ...
            var table = $('#criminales').DataTable({
                ...
                buttons: [{
                        ...
                        title: 'Lista de Criminales',
                        filename: 'criminales_' + new Date().toISOString().slice(0, 10),
                        exportOptions: {
                            columns: ':visible'
                        }
                    },
                    ...
                    },
                    {
                        ...
                        customize: function(win) {
                            $(win.document.body)
                                .css('font-size', '10pt')
                                .prepend(
                                    '<div style="text-align:center;"><h2>LISTA DE CRIMINALES</h2><p>Fecha: ' +
            ...
            // Botón de exportar personalizado
                ...
                const exportMenu = $(`
                    <div class="export-dropdown-menu dropdown-menu show" style="position: absolute; z-index: 1050;">
                        ...
                        <div class="dropdown-item-text small text-muted">
                            Se exportarán solo las columnas visibles
                        </div>
                    </div>
                `);
